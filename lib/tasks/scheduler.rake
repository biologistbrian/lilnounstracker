    	...
    	if tx['input'] == "0xf25efffc"
    		if Newauc.where(hashaddy: tx['hash']).exists?
    			puts "exists"
    		 	...
    		 	twtext = "@LilNounsDao launched a new auction at " + zeetime.to_s + "! Hurry, they end every 15 minutes. See the auction: https://lilnouns.wtf/ \r\n \r\n #NFTs #DAOs #web3 #crypto #blockchain #NFT"
    		 	varr = {:text => "@LilNounsDao launched a new auction at " + zeetime.to_s + "! Hurry, they end every 15 minutes. See the auction: https://lilnouns.wtf/ \r\n \r\n #NFTs #DAOs #web3 #crypto #blockchain #NFT"}
    		 	carr = varr.to_json
